...
def train():
    ...
    if not os.path.exists(os.path.join(config.current_data_path + '/checkpoint',config.pretrained_mode, config.bert_version, model_name)):
        os.makedirs(os.path.join(config.current_data_path + '/checkpoint',config.pretrained_mode, config.bert_version, model_name))
    ...
    checkpoint_dir = os.path.join(config.current_data_path + '/checkpoint', config.pretrained_mode, config.bert_version, model_name)
        ...
        if i % config.num_batches_validate == 0:
            ...
            if early_stop:
                ...
                try:
                    ...
                    best_checkpoint_path = config.current_data_path + f"/checkpoint/{config.pretrained_mode}/{config.bert_version}/{model_name}/ckpt-{step}.pth"
    ...
    # load and print best
    best_checkpoint_path = config.current_data_path + f"/checkpoint/{config.pretrained_mode}/{config.bert_version}/{model_name}/ckpt-{best_step}.pth"
