...
parser.add_argument('--original_data_path', type=str, default='YOUR_FILEdata/',
...
parser.add_argument('--bert_version', type=str, default='original',
                    help='tiny, mini, medium, large')
...
class BaseConfig():
    ...
    original_data_path = args.original_data_path + args.bert_version
