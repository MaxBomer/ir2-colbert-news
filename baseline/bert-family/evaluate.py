...
if __name__ == '__main__':
    ...
    checkpoint_path = latest_checkpoint(os.path.join(config.current_data_path + '/checkpoint', config.pretrained_mode, config.bert_version, model_name))
    ...
    if config.pretrained_mode == 'llama':
        dataset_evaluate_path = os.path.join(config.current_data_path + '/tmp_pkl',config.pretrained_mode, config.bert_version, model_name + "/evaluate_dataset" + str(config.with_prompt) + ".pkl")
    else:
        dataset_evaluate_path = os.path.join(config.current_data_path + '/tmp_pkl',config.pretrained_mode, config.bert_version, model_name + "/evaluate_dataset.pkl")
