...
assert model_name in [
    'NRMS', 'NAML', 'LSTUR', 'DKN', 'HiFiArk', 'TANR', 'Exp1', 'NAMLlinear', 'NRMSlinear', 'LSTURlinear'
]
...
parser.add_argument('--current_data_path', type=str, default='DOWNLOAD_PATH/FOLDER/news-llama/data',
                    help='llm or Copycat, etc. ')
parser.add_argument('--attack_folder', type=str, default='DOWNLOAD_PATH/FOLDER/news-llama/data/attack',
                    help='llm or Copycat, etc. ')
parser.add_argument('--gpt4_attack_text_path', type=str, default="/data/zhaoyy/news_data/data/gpt_data/test/data_at_interaction_598.json",
                    help='llm or Copycat, etc. ')
...
parser.add_argument('--original_data_path', type=str, default='DOWNLOAD_PATH/FOLDER/news-llama/data/original',
...
parser.add_argument('--llama_mode', type=str, default='ori',
                    help='ori, sft, dpo')
...
class BaseConfig():
    ...
    home_folder = '/data/zhaoyy/news_data'
    seed = 2024
