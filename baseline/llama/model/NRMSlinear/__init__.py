import torch
from model.NRMSlinear.news_encoder import NewsEncoder
from model.NRMSlinear.user_encoder import UserEncoder
from model.general.click_predictor.dot_product import DotProductClickPredictor


class NRMSlinear(torch.nn.Module):
    """
    NRMSlinear network.
    Input 1 + K candidate news and a list of user clicked news, produce the click probability.
    """
    def __init__(self, config):
        super(NRMSlinear, self).__init__()
        self.config = config
