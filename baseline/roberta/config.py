...
parser.add_argument('--num_categories', type=int, default=1 + 295,
                    help='`num_categories` in `src/config.py` into 1 + {len(category2int)}')
parser.add_argument('--num_words', type=int, default=1 + 101221,
                    help='`num_words` in `src/config.py` into 1 + {len(word2int)}')
parser.add_argument('--num_entities', type=int, default=1 + 21842,
...
parser.add_argument('--current_data_path', type=str, default='YOUR_FILEdata',
                    help='llm or Copycat, etc. ')
parser.add_argument('--attack_folder', type=str, default='YOUR_FILEdata/attack',
                    help='llm or Copycat, etc. ')
...
parser.add_argument('--original_data_path', type=str, default='YOUR_FILEdata/original',
