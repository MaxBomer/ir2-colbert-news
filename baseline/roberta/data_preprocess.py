...
tokenizer = RobertaTokenizer.from_pretrained(bert_path, legacy=False, clean_up_tokenization_spaces=True)
...
if __name__ == '__main__':
    train_dir = 'YOUR_FILEdata/original/train'
    val_dir = 'YOUR_FILEdata/original/val'
    test_dir = 'YOUR_FILEdata/original/test'
