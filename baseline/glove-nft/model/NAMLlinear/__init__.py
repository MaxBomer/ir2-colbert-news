import torch
from model.NAMLlinear.news_encoder import NewsEncoder
from model.NAMLlinear.user_encoder import UserEncoder
from model.general.click_predictor.dot_product import DotProductClickPredictor


class NAMLlinear(torch.nn.Module):
    """
    NAMLlinear network.
    Input 1 + K candidate news and a list of user clicked news, produce the click probability.
    """
    def __init__(self, config):
        super(NAMLlinear, self).__init__()
        self.config = config
