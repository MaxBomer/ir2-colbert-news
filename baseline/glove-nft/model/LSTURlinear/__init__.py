...
from model.LSTURlinear.news_encoder import NewsEncoder
from model.LSTURlinear.user_encoder import UserEncoder
from model.general.click_predictor.dot_product import DotProductClickPredictor

device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")


class LSTURlinear(torch.nn.Module):
    """
    LSTURlinear network.
    ...
    def __init__(self, config):
        ...
        """
        super(LSTURlinear, self).__init__()
        self.config = config
