...
from evaluate import evaluate, evaluate_popular
import importlib
import datetime
...
def train():
        ...
        if i % config.num_batches_validate == 0:
            ...
            if early_stop:
                ...
                try:
                    ...
                    best_checkpoint_path = f"./checkpoint/{model_name}/ckpt-{step}.pth"
                    torch.save(
                        {
    ...
    # load and print best
    best_checkpoint_path = f"./checkpoint/{model_name}/ckpt-{best_step}.pth"
    ...
    best_auc, best_mrr, best_ndcg5, best_ndcg10 = evaluate(model, './data/' + '/val', config.num_workers, 200000)
    # evaluate_popular(model, './data/' + '/val', config.num_workers, max_count=200000)
    tqdm.write(
